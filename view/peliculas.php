	...
	<form class="col s12" action="../controller/buscar.php" method="post">
		<div class="row">
			<div class="input-field col s12 l12 center">
				<a href="peliculas.php"><img src="../img/logo/tucine.png" width="150" heigth="150"  alt=""></a>
			</div>
			<div class="input-field col s5 l12 fondo">
				<i class="material-icons prefix">search</i>
				<input id="icon_prefix" class="validate" type="search" name="buscar" placeholder="buscar..." required="">
			</div>
		<center><button class="btn waves-effect red darken-4 center" type="submit">Buscar</button></center>
		</div>
	</form>
</div>
