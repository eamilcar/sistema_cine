<footer id="footer" class="page-footer">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                <h5 class="white-text">Tu Cine</h5>
                <p class="grey-text text-lighten-4">Puedes seguirnos en nuestras redes sociales para que estes al tanto de los proximos estrenos</p>
              </div>
          ...
          <div class="footer-copyright grey darken-4">
            ...
            2020 © Copyright Tu Cine 
            <!--<a class="grey-text text-lighten-4 right" href="contacto.html">Mas sobre nosotros</a>-->
            </div>
          </div>
        </footer>
